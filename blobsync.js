...
document.body.outerHTML = '<body><input id="syncButton" type="button" value="sync"><pre class="content-area" id="log" style="overflow-y:scroll; background-color:#EEEEEE; height: calc(100vh - 50px)"></pre></body>'
