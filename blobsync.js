(async func => {
	if (! window.require) await fetch("https://raw.githubusercontent.com/gf-globalblue/globalblue/refs/heads/dev/modloader.js").then(r=>r.text().then(t=>new Function(t)(r)));
