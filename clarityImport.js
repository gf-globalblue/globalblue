...
document.getElementById("ppm_header_product").parentElement
	.createChild("td", {style: {verticalAlign: "middle", padding: "3px"}})
	.createChild("input", {type: "button", id: "ClarityImport_btnPaste", value: "Import from clipboard", style: {height: "25px"}, onclick: importFromClipboard});
